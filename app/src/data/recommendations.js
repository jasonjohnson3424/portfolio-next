export const recommendations = [
  {
    ...
    body: "Jason was a key member of my Digital Learning Solutions team at JPMC, where his expertise in learning technology, vendor evaluations, and digital delivery made a lasting impact. I relied on him to conduct in-depth technical reviews and recommendations for commercial learning tools such as WalkMe, Oracle Guided Learning, the Articulate 360 suite, and AI-driven solutions like Synthesia. His ability to assess these tools for capability, scalability, and fit within the JPMC landscape was invaluable to our decision-making process.\n\nBeyond technical reviews, Jason played a critical role in course development using Articulate and Adobe tools and our custom web-based course development tool, as well as enhancing our custom LCMS and Oracle HCM learning systems. He was exceptional in his delivery of train-the-trainer sessions to internal training developers for our internal course development tool. Clients enjoyed his engaging presentation style, clarity in communication, and ability to simplify complex topics.\n\nHe also worked closely with our learning vendor partners, managing relationships, reviewing vendor materials, and troubleshooting third-party content within our LMS. His ability to balance technical expertise, strategic vendor management, and instructional excellence made him an asset to our team.",
    date: "2025-02",
  ...
  },
  {
    ...
    body: "Jason & I worked together at JPMorgan Chase, over a span of 5 years, both within AWM Learning Technology and later in different teams after a corporate realignment. Jason's technical expertise and deep understanding of learning systems made him an invaluable collaborator, particularly as we navigated complex transitions from legacy LMS platforms to SumTotal and later to Oracle HCM.\n\nJason is not only highly skilled in designing and implementing training solutions but also a strategic thinker who understands how technology can drive business objectives. His ability to lead cross-functional teams, develop structured test plans, streamline content migration, and provide sound technical recommendations was instrumental in ensuring smooth transitions.\n\nBeyond his technical acumen, Jason is a collaborative and personable professional who is always willing to share knowledge and support his colleagues. I valued our time working together and would highly recommend him for any role Jason pursues.",
    date: "2025-02",
...

  {
    ...
    body: "Jason and I worked closely together on the Digital Learning Solutions team within JPMorgan Chase, where we collaborated on training delivery for a custom web-based course development tool built by our department. As reviewers, testers, and trainers, we played a key role in ensuring the tool's success by delivering instructor-led training (ILT) to multiple cohorts of professional training developers. The training was well-received, with excellent feedback from participants, and it directly contributed to enhancing the tool's capabilities and expanding its adoption across the learning organization.\n\nBeyond our collaboration, I had the opportunity to observe Jason's exceptional training development skills, attention to detail, and commitment to quality. He was a technical expert and go-to resource for our department, always willing to provide support and guidance. His ability to simplify complex processes, engage audiences, and drive adoption made him a standout trainer, developer, and product ambassador within the JPMC learning community. I enjoyed working with him.",
    date: "2025-02",
