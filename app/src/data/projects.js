export const projects = [
  ...
  },
  {
    ...
    description:
      "This site — a React SPA with a Node.js/AWS Lambda backend, DynamoDB, and a full CI/CD pipeline via GitHub Actions.",
    challenge: "TBD",
    approach: "TBD",
    outcomes: ["TBD", "TBD"],
    ...
    mediaItems: [
      {
        url: "/placeholder-1280x720.webp",
        type: "image",
        caption: "Homepage hero and project gallery",
      ...
      },
      {
        url: "/placeholder-1280x720.webp",
        type: "image",
        caption: "Project detail page with case study layout",
        alt: "Project detail page screenshot",
        order: 2,
      },
      {
        url: "/placeholder-1280x720.webp",
        type: "image",
        caption: "AWS architecture diagram — Lambda, API Gateway, DynamoDB",
