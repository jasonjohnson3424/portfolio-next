    ...
    mediaItems: [
      {
        ...
        type: "image",
        caption: "Course introduction and learning objectives",
        alt: "Course introduction screen",
        order: 1,
      },
      {
        url: "/placeholder-1280x720.webp",
        type: "image",
        caption: "Branching scenario — handling a delayed delivery",
        alt: "Branching scenario slide",
        order: 2,
      },
      {
        url: "/placeholder-1280x720.webp",
        type: "image",
        caption: "Knowledge check and completion screen",
        alt: "Knowledge check screen",
        order: 3,
      },
    ],
